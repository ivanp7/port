...
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_SCALAR_SUB(uint8, PORT_TYPE_LOGSIZE_QUARTER, as_uint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_SCALAR_SUB(uint16, PORT_TYPE_LOGSIZE_HALF, as_uint_half)
...
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_SCALAR_SUB(sint8, PORT_TYPE_LOGSIZE_QUARTER, as_sint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_SCALAR_SUB(sint16, PORT_TYPE_LOGSIZE_HALF, as_sint_half)
...
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_SCALAR_SUB(memory_ref_quarter, PORT_TYPE_LOGSIZE_QUARTER, as_ref_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_SCALAR_SUB(memory_ref_half, PORT_TYPE_LOGSIZE_HALF, as_ref_half)
...
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint8, 2, PORT_TYPE_LOGSIZE_QUARTER, as_uint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint8, 3, PORT_TYPE_LOGSIZE_QUARTER, as_uint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint8, 4, PORT_TYPE_LOGSIZE_QUARTER, as_uint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint8, 8, PORT_TYPE_LOGSIZE_QUARTER, as_uint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint8, 16, PORT_TYPE_LOGSIZE_QUARTER, as_uint_quarter)

PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint16, 2, PORT_TYPE_LOGSIZE_HALF, as_uint_half)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint16, 3, PORT_TYPE_LOGSIZE_HALF, as_uint_half)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint16, 4, PORT_TYPE_LOGSIZE_HALF, as_uint_half)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint16, 8, PORT_TYPE_LOGSIZE_HALF, as_uint_half)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(uint16, 16, PORT_TYPE_LOGSIZE_HALF, as_uint_half)
...
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint8, 2, PORT_TYPE_LOGSIZE_QUARTER, as_sint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint8, 3, PORT_TYPE_LOGSIZE_QUARTER, as_sint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint8, 4, PORT_TYPE_LOGSIZE_QUARTER, as_sint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint8, 8, PORT_TYPE_LOGSIZE_QUARTER, as_sint_quarter)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint8, 16, PORT_TYPE_LOGSIZE_QUARTER, as_sint_quarter)

PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint16, 2, PORT_TYPE_LOGSIZE_HALF, as_sint_half)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint16, 3, PORT_TYPE_LOGSIZE_HALF, as_sint_half)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint16, 4, PORT_TYPE_LOGSIZE_HALF, as_sint_half)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint16, 8, PORT_TYPE_LOGSIZE_HALF, as_sint_half)
PORT_DEFINE_MEMORY_WRITE_FUNCTIONS_VECTOR_SUB(sint16, 16, PORT_TYPE_LOGSIZE_HALF, as_sint_half)
