...
#define PORT_EXTRACT_BITS(type, value, shift, length) \
    ((type)(((value) >> (shift)) & (((type)1 << (length)) - 1)))
...
/**
 * @brief 8-bit mask with nth bit set.
 */
#define PORT_BIT8(n) ((port_uint8_t)((port_uint8_t)1 << (n)))
/**
 * @brief 16-bit mask with nth bit set.
 */
#define PORT_BIT16(n) ((port_uint16_t)((port_uint16_t)1 << (n)))
/**
 * @brief 32-bit mask with nth bit set.
 */
#define PORT_BIT32(n) ((port_uint32_t)((port_uint32_t)1 << (n)))
/**
 * @brief 64-bit mask with nth bit set.
 */
