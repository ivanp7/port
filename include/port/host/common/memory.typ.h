...
/**
 * @brief Memory cluster.
 */
typedef struct port_memory_cluster {
    port_memory_ptr_t *blocks; ///< Separately allocated memory blocks.
    port_size_t *block_sizes;  ///< Sizes of memory blocks in units.
    port_size_t num_blocks;    ///< Number of memory blocks.
} port_memory_cluster_t;
