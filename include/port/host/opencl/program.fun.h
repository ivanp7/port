...
port_opencl_build_program(
        ...
        cl_uint num_headers,                ///< [in] Number of header files.
        const char *header_include_names[], ///< [in] #include names of header files.
        const char *headers[],              ///< [in] Header files.
        const size_t header_sizes[],        ///< [in] Sizes of header files.

        cl_uint num_sources,         ///< [in] Number of source files.
        const char *source_names[],  ///< [in] Names of source files.
        const char *sources[],       ///< [in] Source files.
        const size_t source_sizes[], ///< [in] Sizes of source files.

        cl_uint num_libraries,        ///< [in] Number of libraries.
